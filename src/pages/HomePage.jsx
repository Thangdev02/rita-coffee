...
<section className="py-24 px-6 overflow-hidden">
  <div className="max-w-7xl mx-auto">
    ...
    <div className="grid grid-cols-2 md:grid-cols-4 gap-3 auto-rows-[180px] md:auto-rows-[200px]">
      {[
        { src: '/menu/assets/khach1.jpg', span: 'row-span-2 col-span-1' },
        { src: '/menu/assets/khach2.jpg', span: 'col-span-1' },
        { src: '/menu/assets/khach3.jpg', span: 'col-span-2 row-span-1' },
        { src: '/menu/assets/khach4.jpg', span: 'col-span-1' },
        { src: '/menu/assets/khach5.jpg', span: 'col-span-2 row-span-2' },
        { src: '/menu/assets/khach6.jpg', span: 'col-span-1' },
        { src: '/menu/assets/khach7.jpg', span: 'col-span-1' },
        { src: '/menu/assets/khach2.jpg', span: 'col-span-2 row-span-1' },
      ].map((photo, i) => (
